...
<?php endif; ?>
            ...
            <div class="card">
                <nav class="tabs">
                    <a href="#" class="active" onclick="switchTab('password-tab', this);
                        return false;"><?php echo __('share_password'); ?></a>
                    <a href="#" onclick="switchTab('text-tab', this);
                        return false;"><?php echo __('share_text'); ?></a>
                </nav>
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="password-group">
                                    <input type="text" name="data" id="password-input" required onmouseover="this.classList.remove('blur');" onmouseout="if (this.value.trim() !== '') {
